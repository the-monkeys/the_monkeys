...
- Use this page as the authoritative reference for **pages / building-your-application / routing / custom-error**.
...
Reference: https://nextjs.org/docs/pages/building-your-application/routing/custom-error
