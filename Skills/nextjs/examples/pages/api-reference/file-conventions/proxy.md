...
- Use this page as the authoritative reference for **pages / api-reference / file-conventions / proxy**.
...
Reference: https://nextjs.org/docs/pages/api-reference/file-conventions/proxy
