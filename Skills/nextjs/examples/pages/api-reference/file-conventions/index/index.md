...
- Use this page as the authoritative reference for **pages / api-reference / file-conventions / index / index**.
...
Reference: https://nextjs.org/docs/pages/api-reference/file-conventions
