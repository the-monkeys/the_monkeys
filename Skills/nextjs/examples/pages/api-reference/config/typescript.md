...
- Use this page as the authoritative reference for **pages / api-reference / config / typescript**.
...
Reference: https://nextjs.org/docs/pages/api-reference/config/typescript
