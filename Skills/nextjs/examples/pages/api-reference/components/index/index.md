...
- Use this page as the authoritative reference for **pages / api-reference / components / index / index**.
...
Reference: https://nextjs.org/docs/pages/api-reference/components
