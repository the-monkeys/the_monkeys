...
- Use this page as the authoritative reference for **pages / api-reference / components / image-legacy**.
...
Reference: https://nextjs.org/docs/pages/api-reference/components/image-legacy
