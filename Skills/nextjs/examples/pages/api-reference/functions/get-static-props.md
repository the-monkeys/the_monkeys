...
- Use this page as the authoritative reference for **pages / api-reference / functions / get-static-props**.
...
Reference: https://nextjs.org/docs/pages/api-reference/functions/get-static-props
