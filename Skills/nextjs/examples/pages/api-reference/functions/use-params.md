...
- Use this page as the authoritative reference for **pages / api-reference / functions / use-params**.
...
Reference: https://nextjs.org/docs/pages/api-reference/functions/use-params
