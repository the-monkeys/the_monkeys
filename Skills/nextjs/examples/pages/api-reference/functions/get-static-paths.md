...
- Use this page as the authoritative reference for **pages / api-reference / functions / get-static-paths**.
...
Reference: https://nextjs.org/docs/pages/api-reference/functions/get-static-paths
