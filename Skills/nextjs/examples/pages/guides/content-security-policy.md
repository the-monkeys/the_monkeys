...
- Use this page as the authoritative reference for **pages / guides / content-security-policy**.
...
Reference: https://nextjs.org/docs/pages/guides/content-security-policy
