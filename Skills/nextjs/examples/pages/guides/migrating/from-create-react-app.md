...
- Use this page as the authoritative reference for **pages / guides / migrating / from-create-react-app**.
...
Reference: https://nextjs.org/docs/pages/guides/migrating/from-create-react-app
