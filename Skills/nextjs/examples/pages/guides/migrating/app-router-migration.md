...
- Use this page as the authoritative reference for **pages / guides / migrating / app-router-migration**.
...
Reference: https://nextjs.org/docs/pages/guides/migrating/app-router-migration
