...
- Use this page as the authoritative reference for **app / api-reference / functions / use-link-status**.
...
Reference: https://nextjs.org/docs/app/api-reference/functions/use-link-status
