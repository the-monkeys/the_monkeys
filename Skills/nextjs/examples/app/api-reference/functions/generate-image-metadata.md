...
- Use this page as the authoritative reference for **app / api-reference / functions / generate-image-metadata**.
...
Reference: https://nextjs.org/docs/app/api-reference/functions/generate-image-metadata
