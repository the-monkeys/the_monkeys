...
- Use this page as the authoritative reference for **app / api-reference / functions / cacheTag**.
...
Reference: https://nextjs.org/docs/app/api-reference/functions/cacheTag
