...
- Use this page as the authoritative reference for **app / guides / migrating / from-create-react-app**.
...
Reference: https://nextjs.org/docs/app/guides/migrating/from-create-react-app
