...
- Use this page as the authoritative reference for **app / api-reference / functions / generate-sitemaps**.
...
Reference: https://nextjs.org/docs/app/api-reference/functions/generate-sitemaps
