...
- Use this page as the authoritative reference for **app / api-reference / functions / use-report-web-vitals**.
...
Reference: https://nextjs.org/docs/app/api-reference/functions/use-report-web-vitals
