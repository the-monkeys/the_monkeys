...
- Use this page as the authoritative reference for **app / api-reference / functions / image-response**.
...
Reference: https://nextjs.org/docs/app/api-reference/functions/image-response
