...
- Use this page as the authoritative reference for **app / api-reference / file-conventions / public-folder**.
...
Reference: https://nextjs.org/docs/app/api-reference/file-conventions/public-folder
