...
- Use this page as the authoritative reference for **pages / getting-started / project-structure**.
...
Reference: https://nextjs.org/docs/pages/getting-started/project-structure
