...
- Use this page as the authoritative reference for **pages / api-reference / components / script**.
...
Reference: https://nextjs.org/docs/pages/api-reference/components/script
