...
- Use this page as the authoritative reference for **pages / api-reference / cli / create-next-app**.
...
Reference: https://nextjs.org/docs/pages/api-reference/cli/create-next-app
