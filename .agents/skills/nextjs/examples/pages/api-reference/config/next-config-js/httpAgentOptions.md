...
- Use this page as the authoritative reference for **pages / api-reference / config / next-config-js / httpAgentOptions**.
...
Reference: https://nextjs.org/docs/pages/api-reference/config/next-config-js/httpAgentOptions
