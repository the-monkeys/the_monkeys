...
- Use this page as the authoritative reference for **pages / api-reference / functions / next-request**.
...
Reference: https://nextjs.org/docs/pages/api-reference/functions/next-request
