...
const TopNews = () => {
  ...
  return (
    <div className='hidden md:block '>
      <div className='bg-monkeyWhite p-4  max-w-md mx-auto'>
        ...
        {newsData &&
          newsData.slice(0, 13).map((newsItem: any, index: number) => (
            <div key={index}>
              <ul>
                <li className='flex justify-between py-[7.3px] last:border-none'>
