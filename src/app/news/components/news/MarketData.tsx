  ...
  return (
    <Marquee speed={25} pauseOnHover={true} className='py-2'>
      ...
      <div className='mx-4 flex gap-2 items-center'>
        ...
        <div className='px-1 rounded-md bg-green-500 text-secondary-white'>
          <p className='font-jost font-medium text-sm sm:text-base'>▲ +0.04%</p>
        </div>
      </div>
      ...
      <div className='mx-4 flex gap-2 items-center'>
        ...
        <div className='px-1 rounded-md bg-red-500 text-secondary-white'>
          <p className='font-jost font-medium text-sm sm:text-base'>▼ -0.34%</p>
        </div>
      </div>
      ...
      <div className='mx-4 flex gap-2 items-center'>
        ...
        <div className='px-1 rounded-md bg-green-500 text-secondary-white'>
          <p className='font-jost font-medium text-sm sm:text-base'>▲ +0.45%</p>
        </div>
      </div>
      ...
      <div className='mx-4 flex gap-2 items-center'>
        ...
        <div className='px-1 rounded-md bg-green-500 text-secondary-white'>
          <p className='font-jost font-medium text-sm sm:text-base'>▲ +2.23%</p>
        </div>
      </div>
      ...
      <div className='mx-4 flex gap-2 items-center'>
        ...
        <div className='px-1 rounded-md bg-green-500 text-secondary-white'>
          <p className='font-jost font-medium text-sm sm:text-base'>▲ +1.92%</p>
        </div>
      </div>
    </Marquee>
  );
