...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      'inline-flex h-8 shrink-0 items-center justify-center border-1 border-secondary-lightGrey/25 px-3 transition-colors focus:outline-none hover:ring-1 hover:ring-secondary-lightGrey/25 font-roboto rounded-md text-sm',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description
    ref={ref}
    className={cn('text-sm font-roboto opacity-90', className)}
    {...props}
  />
));
