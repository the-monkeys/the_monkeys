      ...
      px-6 py-5 md:py-10 mx-auto space-y-8 md:flex-row md:space-y-0 ">
        ...
        <div className="flex flex-col items-center justify-around space-y-5
         md:items-start mt-8 md:mt-0">
          ...
          <div className="w-full flex items-center justify-center space-x-4">
            <Link to="https://www.facebook.com"><img src={FbIcon} alt="facebook-logo"></img></Link>
            <Link to="https://www.twitter.com"><img src={TwitterIcon} alt="Twitter-logo"></img></Link>
          </div>
        ...
        <div className="flex justify-around space-x-18 md:space-x-32">
				<div className="links flex flex-col space-y-3 text-white">
					...
					<Link to="/"  className="hover:text-gray">About</Link>
					<Link to="/"  className="hover:text-gray">Explore</Link>
					<Link to="/"  className="hover:text-gray">Publishers</Link>
				</div>
				<div className="links flex flex-col space-y-3 text-white">
					<Link to="/"  className="hover:text-gray">Developers</Link>
					<Link to="/"  className="hover:text-gray">Terms of service</Link>
					<Link to="/"  className="hover:text-gray">Privacy Policy</Link>
					<Link to="/"  className="hover:text-gray">Support</Link>
				</div>
			</div>
      <div className="flex flex-col justify-between">
				<form>
					<div className="flex space-x-3">
						<input type="text" className="border-solid border-2 border-lightBlack flex-1 px-4 rounded"
						placeholder="Get Updates" />
						<button className="px-6 py-1 rounded text-offWhite bg-lightBlack hover:bg-transparent hover:text-lightBlack focus:outline-none hover:border-solid border-2 border-lightBlack">Go</button>
					</div>
				</form>
...
>>>>>>> c06e587b78a1084801038161f763e78a36d62ba6
