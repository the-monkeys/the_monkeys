...
export const LinksSection = () => {
  return (
    <div className='mx-auto max-w-5xl px-4 grid grid-cols-2 gap-4 md:gap-6'>
      <div className='col-span-2 md:col-span-1 px-3 sm:px-4 py-4 sm:py-5 flex flex-col bg-foreground-light/15 dark:bg-foreground-dark/15 border-1 border-foreground-light dark:border-foreground-dark rounded-xl'>
        <h2 className='pb-2 font-dm_sans font-medium text-xl sm:text-2xl'>
          <span className='text-brand-orange'>Discover</span> Endless
          Possibilities
        </h2>

        <p className='mb-4 sm:mb-6 font-roboto font-light text-sm md:text-base'>
          With an ever-growing range of topics, there&apos;s always something
          fresh and exciting to explore.
        </p>

        <Button className='group w-fit pl-6 pr-4 self-end rounded-full' asChild>
          <Link href='/feed'>
            Discover
            <Icon
              name='RiArrowRight'
      ...
      <div className='col-span-2 md:col-span-1 p-4 flex flex-col bg-foreground-light/15 dark:bg-foreground-dark/15 border-1 border-foreground-light dark:border-foreground-dark rounded-xl'>
        <h2 className='pb-2 font-dm_sans font-medium text-xl sm:text-2xl'>
