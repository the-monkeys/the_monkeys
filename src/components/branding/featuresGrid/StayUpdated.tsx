...
const StayUpdated = () => {
  return (
    <GridContainer className='group col-span-2 sm:col-span-1 space-y-4'>
      ...
      <div
        className='px-4 h-40 grid grid-cols-3 gap-1 overflow-hidden'
        aria-disabled='true'
      >
        <div className='row-span-1 col-span-2 sm:col-span-3 flex gap-2 group-hover:-mt-10 transition-all'>
          ...
          <div className='pt-1 flex-1 space-y-1'>
            <div className='w-1/2 sm:w-1/4 h-1 bg-primary-monkeyOrange rounded-full' />
        ...
        <div className='row-span-3 col-span-1 flex sm:hidden flex-col gap-1'>
          ...
          <div className='w-1/2 h-1 bg-primary-monkeyOrange rounded-full' />
          <div className='w-full h-1 bg-secondary-darkGrey/15 dark:bg-secondary-white/15' />
          <div className='w-full h-1 bg-secondary-darkGrey/15 dark:bg-secondary-white/15 transition-all' />
          <div className='mb-1 w-full h-1 bg-secondary-darkGrey/15 dark:bg-secondary-white/15 transition-all' />
