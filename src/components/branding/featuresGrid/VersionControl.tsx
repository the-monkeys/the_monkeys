...
const VersionControl = () => {
  return (
    <GridContainer className='flex flex-col hover:border-primary-monkeyOrange/25'>
      ...
      <div
        className='mt-8 flex-1 flex flex-col items-center justify-end overflow-hidden animate-appear-up'
        aria-disabled='true'
      >
        <div className='flex-1 w-full p-2 transition-all'>
          <p className='px-2 font-josefin_Sans font-medium text-lg sm:text-xl text-primary-monkeyOrange cursor-default'>
            Blog Title: v2.0.2
          </p>
          ...
          <p className='mt-4 p-1 font-jost text-xs sm:text-sm text-right cursor-default'>
            Blocks changed: 15
          </p>
