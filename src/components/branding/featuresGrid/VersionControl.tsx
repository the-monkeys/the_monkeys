    ...
    <GridContainer className='h-full group row-span-4 col-span-5 lg:col-span-2 space-y-4'>
      ...
      <div className='h-full px-4' aria-disabled='true'>
        <div className='relative py-2 flex flex-col items-center gap-2'>
          <div className='absolute top-0 left-1/2 h-0 group-hover:h-full w-1 bg-primary-monkeyOrange -z-10 transition-all delay-75' />

          <div className='w-4/5 sm:w-1/2 p-4 bg-primary-monkeyWhite dark:bg-primary-monkeyBlack border-1 border-secondary-lightGrey/25 group-hover:border-primary-monkeyOrange/50 rounded-lg hidden lg:block'>
          ...
          <div className='w-4/5 sm:w-1/2 p-4 bg-primary-monkeyWhite dark:bg-primary-monkeyBlack border-1 border-secondary-lightGrey/25 group-hover:border-primary-monkeyOrange/50 rounded-lg'>
            <p className='font-josefin_Sans text-sm sm:text-base'>
              Release v1.2
            </p>
        ...
        <div className='mx-auto w-full sm:w-4/5 lg:w-full h-full p-4 pb-0 flex-1  border-2 border-secondary-lightGrey/25 group-hover:border-primary-monkeyOrange rounded-lg transition delay-75'>
