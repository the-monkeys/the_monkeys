    ...
    <GridContainer className='h-full group row-span-4 col-span-5 lg:col-span-2 space-y-4'>
      ...
      <div className='h-full px-4' aria-disabled='true'>
        <div className='relative py-2 flex flex-col items-center gap-2'>
          ...
          <div className='w-4/5 sm:w-1/2 px-4 py-2 bg-primary-monkeyWhite dark:bg-primary-monkeyBlack border-1 border-secondary-lightGrey/25 group-hover:border-primary-monkeyOrange/50 rounded-md hidden lg:block'>
            <p className='font-dm_sans text-sm sm:text-base'>Release v0.8</p>

            <div className='flex justify-between gap-1 flex-wrap text-secondary-darkGrey/75 dark:text-secondary-white/75'>
              <p className='font-roboto text-xs sm:text-sm'>by Ashley</p>
              <p className='font-roboto text-xs sm:text-sm'>2 months ago</p>
            </div>
          </div>

          <div className='w-4/5 sm:w-1/2 px-4 py-2 bg-primary-monkeyWhite dark:bg-primary-monkeyBlack border-1 border-secondary-lightGrey/25 group-hover:border-primary-monkeyOrange/50 rounded-md'>
            <p className='font-dm_sans text-sm sm:text-base'>Release v1.2</p>

            <div className='flex justify-between gap-1 flex-wrap text-secondary-darkGrey/75 dark:text-secondary-white/75'>
              <p className='font-roboto text-xs sm:text-sm'>by Phil</p>
              <p className='font-roboto text-xs sm:text-sm'>27 days ago</p>
            </div>
          </div>
        </div>

        <div className='mx-auto w-full sm:w-4/5 lg:w-full h-full p-4 pb-0 flex-1 border-1 border-secondary-lightGrey/25 group-hover:border-primary-monkeyOrange rounded-md transition-all delay-75'>
          <p className='font-dm_sans font-medium text-lg sm:text-xl'>
            Release v1.8
          </p>

          <p className='mb-4 font-roboto text-xs sm:text-sm opacity-75'>
            by Ashley, Phil & Rahul
          </p>

          <div className='mb-2 flex justify-between flex-wrap gap-2'>
            <p className='font-roboto text-xs sm:text-sm'>Blocks changed: 15</p>

            <p className='font-roboto text-xs sm:text-sm'>5 mins ago</p>
          </div>
