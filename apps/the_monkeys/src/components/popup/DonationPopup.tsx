    ...
    >
      ...
      >
        <div className='flex items-center justify-between mb-4'>
          <h3 className='text-xl font-semibold text-gray-900 dark:text-gray-200 pr-6'>
            Support Monkeys
          </h3>
        ...
        <p className='text-sm text-gray-600 dark:text-gray-300 mb-6 leading-relaxed'>
          Monkeys is a research-first writing platform built for tech research,
          education, and open-source engineering. We are inviting supporters to
          help us keep the lights on and push the work forward.
        </p>
