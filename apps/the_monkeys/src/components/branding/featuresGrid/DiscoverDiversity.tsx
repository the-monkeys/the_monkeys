...
export const DiverseTopics = () => {
  return (
    <div className='group p-4 md:p-6 col-span-3 sm:col-span-2 md:col-span-1 flex flex-col justify-end gap-6 bg-background-light dark:bg-background-dark border-1 border-border-light dark:border-border-dark rounded-xl overflow-hidden'>
