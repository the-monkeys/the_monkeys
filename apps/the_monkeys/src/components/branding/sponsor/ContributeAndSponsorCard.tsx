...
export const ContributeAndSponsorCard = ({
  ...
  return (
    <div
      className={twMerge(
        className,
        'p-[1px] bg-gradient-to-r from-blue-500/40 to-pink-500/40 rounded-sm overflow-hidden'
      )}
    >
      <div className='p-4 sm:p-6 bg-background-light dark:bg-background-dark space-y-6'>
        <div className='space-y-1'>
          <h4 className='font-dm_sans font-semibold text-xl leading-tight drop-shadow-sm'>
        ...
        <div className='w-full flex-1 flex gap-3 flex-wrap'>
          <Button
            variant='outline'
            className='flex-1 rounded-sm !border-1 !border-blue-500/50 hover:!bg-blue-500/25'
            asChild
          >
            <Link
          ...
          <Button
            variant='outline'
            className='flex-1 rounded-sm !border-1 !border-pink-500/50 hover:!bg-pink-500/25'
            asChild
          >
            <Link
